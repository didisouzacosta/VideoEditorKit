...
- a camada `Views/` deve usar `SwiftUI` como regra; não importar `UIKit` diretamente em views. Quando uma bridge UIKit for inevitável, isolá-la fora de `Views/` e expor apenas uma API SwiftUI para consumo
